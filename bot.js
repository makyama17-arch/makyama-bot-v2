// ============================================================
// MAKYAMA GLOBAL OPPORTUNITIES BOT V9.1
// ============================================================
// GLOBAL:
// - Work Opportunities
// - Jobs
...
// - No admin.apps.length
// - Realtime Database supported
// - Grants.gov POSTED ONLY
// - Expired opportunities removed
// - Invalid URLs removed
// - Official publication dates preserved
// - Details API included
// - Ads API included
// - Automatic run every 30 minutes
// ============================================================
...
const USER_AGENT =
  "MAKYAMA-Global-Opportunities-Bot/9.1 (+https://makyama.vercel.app)";

const MAX_REMOTIVE_JOBS =
  100;
...
app.listen(
  ...
  () => {
    ...
    console.log(
      "Expired cleanup: ENABLED"
    );

    console.log(
      "Official dates: ENABLED"
    );
...
async function runBot() {
  ...
  if (!firebaseOK) {
    ...
    console.error(
      "❌ Firebase unavailable. Skipping this bot cycle."
    );
